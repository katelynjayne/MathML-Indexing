...
def bplus_approach(filename, ignore):
    start_time = time()
    ...
    return top_ten, execution_time, avg_score, max_score, scores
...
if __name__ == "__main__":
    bplus_result, bplus_time, bplus_avg, bplus_max = bplus_approach("./Queries/1.html")
    print(bplus_result)
    # useable_files = []
